    ...
    <div className="container mx-auto px-4 py-5">
      <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
        <div className="flex flex-1 flex-wrap items-center gap-6">
          <ContactPill icon={<Circle><PhoneIcon /></Circle>} title="Talk to us" value="1800-123-1555" href="tel:18001231555" />
          <ContactPill icon={<Circle><span className="text-lg">?</span></Circle>} title="Helpcentre" value="help.trendline.com" href="https://help.trendline.com" />
          <ContactPill icon={<Circle><MailIcon /></Circle>} title="Write to us" value="help@trendline.com" href="mailto:help@trendline.com" />
          <ContactPill icon={<Circle><span className="text-lg">✉️</span></Circle>} title="Contact page" value="All options in one place" href="/contact" />
        </div>
